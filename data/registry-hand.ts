...
/**
 * Saisie à la main, telle qu'elle existe depuis l'origine du projet.
 *
 * Ce n'est plus ce que l'app consomme : `ELEMENT_DATA_REGISTRY` (data/registry.ts)
 * est désormais produit par `resolvers/buildings.ts`, qui greffe l'extraction
 * par-dessus cette table. Elle reste la source des niveaux et des coûts.
 */
export const HAND_ELEMENT_DATA: Record<string, BuildingData> = {
  // capital - homes
