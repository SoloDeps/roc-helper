...
export const sections_ME: PresetSection[] = [
  ...
  },
  {
    ...
    category: "capital",
    entries: [
      { buildingId: "artisan",     type: "construction", era: "ME", level: 2, qty: 1 },
      { buildingId: "artisan",     type: "upgrade",      era: "ME", level: 2, qty: 1 },
      { buildingId: "stone_mason", type: "upgrade",      era: "ME", level: 2, qty: 1 },
      { buildingId: "tailor",      type: "upgrade",      era: "ME", level: 2, qty: 1 },
    ],
  },
  {
    id: "egypt_homes_ME",
