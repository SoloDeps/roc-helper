...
export function CompareButton({
  ...
  // Solution : Garder le Tooltip toujours non-contrôlé
  // Il s'affichera automatiquement au hover seulement si le bouton est désactivé
  return (
    ...
    //     {/* Le tooltip ne s'affichera que si le bouton est désactivé */}
    //     {desactive && (
    //       <TooltipContent
    //         side="left"
